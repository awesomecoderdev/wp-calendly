 ...
 *
 * @wordpress-plugin
 * Plugin Name:       WP Calendly
 * Plugin URI:        https://awesomecoder.dev/
 * Description:       This is custom plugin that included custom functionality with Calendly.
 * Version:           1.0.0
...
use AwesomeCoder\Plugin\Calendly\Core\Plugin;
 ...
 */
define('AWESOMECODER_CALENDLY_VERSION', '1.0.0');
define('AWESOMECODER_CALENDLY_URL', plugin_dir_url(__FILE__));
define('AWESOMECODER_CALENDLY_PATH', plugin_dir_path(__FILE__));
define('AWESOMECODER_CALENDLY_BASENAME', plugin_basename(__FILE__));

...
namespace AwesomeCoder\Plugin\Calendly\Controller;

use AwesomeCoder\Plugin\Calendly\Backend\Awesomecoder_Backend;
use AwesomeCoder\Plugin\Calendly\Frontend\Awesomecoder_Frontend;
...
class Awesomecoder
{
	...
	{
		if (defined('AWESOMECODER_CALENDLY_VERSION')) {
			$this->version = AWESOMECODER_CALENDLY_VERSION;
		} else {
			$this->version = '1.0.0';
		}
	...
	private function load_dependencies()
	{
		 ...
		 * core plugin.
		 */
		require_once AWESOMECODER_CALENDLY_PATH . 'controller/class-awesomecoder-activator.php';

		/**
		 * The class responsible for orchestrating the actions and filters of the
		 * core plugin.
		 */
		require_once AWESOMECODER_CALENDLY_PATH . 'controller/class-awesomecoder-deactivator.php';

		/**
		 * The class responsible for orchestrating the actions and filters of the
		 * core plugin.
		 */
		require_once AWESOMECODER_CALENDLY_PATH . 'controller/class-awesomecoder-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once AWESOMECODER_CALENDLY_PATH . 'controller/class-awesomecoder-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the backend area.
		 */
		require_once AWESOMECODER_CALENDLY_PATH . 'backend/class-awesomecoder-backend.php';

		/**
		 * The class responsible for defining all actions that occur in the frontend-facing
		 * side of the site.
		 */
		require_once AWESOMECODER_CALENDLY_PATH . 'frontend/class-awesomecoder-frontend.php';

		/**
		 * The class responsible for defining metabox functionality
		 * of the plugin.
		 */
		require_once AWESOMECODER_CALENDLY_PATH . 'controller/class-awesomecoder-shortcode.php';

		/**
		 * The class responsible for defining handler functionality
		 * of the plugin.
		 */
		require_once AWESOMECODER_CALENDLY_PATH . 'controller/class-awesomecoder-handler.php';

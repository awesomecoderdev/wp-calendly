...
class Awesomecoder_Shortcode
{
	 ...
	 *
	 */
	public static function awesomecoder_calendly_shortcode_callback($atts = array(), $content = null, $tag = '')
	{
		...
		ob_start();
		include_once AWESOMECODER_CALENDLY_PATH . 'frontend/views/shortcode/calendly.php';
	...
	{
		add_shortcode('awesomecoder_calendly', [__CLASS__, 'awesomecoder_calendly_shortcode_callback']);
	}
}
